...
@foreach($users as $users)
    ...
    <form action="welcome" method="GET"><button class="btn btn-primary rounded-0">Show</button>
    </form>
    <form action="welcome" method="GET"><button class="btn btn-warning rounded-0">Edit</button>
    </form>
